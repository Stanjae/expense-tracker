...
const SuccessM = () => {
  return (
    <div> 
        ...
        <div id="successModal" tabindex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-1/2 right-1/2 left-1/2 z-50 justify-center items-center w-full h-modal md:h-full">
